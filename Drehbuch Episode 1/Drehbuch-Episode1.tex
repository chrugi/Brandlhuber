...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Jans Zimmer}{Morgen}{\scnn{Jan Aebersold} wacht auf und merkt, dass er
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Bus}{Morgen}{\scnn{Jan} sitzt müde im Bus und schaut aus dem
  Fenster. Er sieht die Stadt Zürich von oben im morgendlichen Nebel.}


% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{ext}{Hochschule Hönggerberg}{Morgen}{\scnn{Jan} trifft auf \scnn{Tim
    Bergmann}. Tim wartet bereits vor dem Haupteingang des HIL Gebäudes. Er
  raucht eine Zigarette und hält einen Becher Kaffee in der Hand. Als Jan Tim
  erreicht, betreten sie schnell das Gebäude.}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
%\scn{int}{Casutts Büro}{Vormittag}{\scnn{Dr. Darko Yanev} sitzt ungeduldig im
%  Büro von \scnn{Hochschulpräsident Andrin Casutt} und wartet. Casutt tritt
%  ein.}
%
%\dlg{Casutt}{Dr. Yanev. Vielen Dank, dass sie so kurzfristig kommen konnten.}
%
%\dsc{Casutt setzt sich}
%
%\dlg{Casutt}{Nun, ich will ganz offen mit Ihnen sprechen. Sie wissen ja
...
%
%\dlg{Yanev}{Ja, das ist mir zu Ohren gekommen. Aber was hat dies mit mir zu
%  tun?}
%
%\dsc{Casutt wartet einen Moment, bevor er fortfährt}
%
%\dlg{Casutt}{Ihre Forschung hat bis jetzt sehr wenige Früchte getragen. Ich habe
%  Ihnen bereits mehrfach einen Zeitaufschub gewährt um zu Resultaten zu
...
%
%\dlg{Yanev}{Aber ich bin nun endlich unmittelbar vor dem grossen Durchbruch!
%  Das Programm funktioniert und ist ganz kurz vor der Vollendung!  Geben Sie mir
%  doch nur noch eine Wo..}
%
%\dsc{Casutt unterbricht Yanev}
%
%\dlg{Casutt}{Ich habe mich doch bezüglich den zeitlichen Rahmenbedingungen das
...
%
%\dlg{Yanev}{Bin ich... Entlassen?}
%
%\dlg{Casutt}{Sie sind an ihrem Departement ja als Informatiker
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Koje - Hochschule}{Vormittag}{\scnn{Jan} sitzt frustriert vor seinem
  Computer. Das Programm Dreamfetcher stürzt immer wieder ab. Er bittet
  \scnn{Tim} um Hilfe, aber der kann ihm auch nicht helfen. Sie wenden sich an
  \scnn{Alessia}, da beide wissen wie gut sie mit Computern umgehen kann.}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Helpdesk - Hochschule}{Nachmittag}{\scnn{Dr. Darko Yanev} ist schlecht
  gelaunt. Er sitzt am Helpdesk und erklärt gerade einem \scnn{Studenten}, dass
  er ihm nicht helfen kann. \scnn{Jan} wartet ab bis er an der Reihe ist und
  erklärt dann sein Problem.}
...
\xdlg{Yanev}{Hast du versucht den Computer neu zu starten?}{sichtlich genervt}
...
\dsc{Jan zeigt seinen alten Computer. Yanev scheint offenbar interessierter.}

\dlg{Yanev}{Zeig mal her. Ich werde mir das ansehen.}

\dsc{Yanev tippt ein wenig in den Tasten herum.}

\dlg{Yanev}{Hm. Ich fürchte, ich kann da nichts machen. Es scheint tatsächlich
...
\dlg{Yanev}{Dann kann ich dir nicht helfen. Ich verstehe deine Not. Aber alles
...
\dlg{Yanev}{Keine Sorge. Ich werde deinen Computer bis heute abend fertig
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Alumni Lounge - Hochschule}{Abend}{\scnn{Jan} sitzt frustriert und
  müde am Tisch. Neben sich einen leeren Kaffeebecher. Er schaut immer wieder
  auf sein Mobiltelefon und wartet gestresst auf den Anruf von
  \scnn{Yanev}. Gedankenverloren kritzelt er in ein Notizbuch und versucht sein
  Projekt von Hand zu skizzieren. Endlich klingelt das Telefon. Sein Computer
  ist abholbereit. \scnn{Jan} packt hastig seine Sachen zusammen und geht.}

\xdlg{Yanev}{Hallo Jan.\\ Ich habe deinen Computer nun fertig. Du kannst ihn nun
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Helpdesk - Hoschschule}{Abend}{\scnn{Yanev} übergibt \scnn{Jan} den
  Laptop. \scnn{Jan} ist sichtlich erleichtert.}

\dlg{Yanev}{Mit der alten Installation war nichts mehr anzufangen. Ich habe dir
...
\dlg{Yanev}{Mach dir deswegen mal keine allzu grossen Gedanken. Du wirst
...
\xdlg{Yanev}{Ich glaube nicht, dass du das schaffst. Das wünsche ich dir
  auch.}{lachend}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Jans Zimmer}{Nacht}{\scnn{Jan} startet seinen Computer und dann auch
  gleich das Programm. Man sieht ihm an, dass er eigentlich überhaupt keine
...
\dsc{Jan zögert zunächst. Er ist überfordert mit der neuen, viel
  ...
  mit Jan entwirft. Jan muss also nicht mehr am Computer sitzen und geht im
  Zimmer auf und ab während er Mira den Entwurf diktiert. Mira hinterfragt alles
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Plotterraum}{Am nächsten Morgen}{\scnn{Jan} steht müde aber glücklich
  und erleichtert beim Plotter und sammelt seine Ausdrucke zusammen. \scnn{Tim}
  findet Jan und bringt ihm einen Kaffee.}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Koje bei der Kritik - Hoschschule}{Im Verlaufe des Tages}{\scnn{Jan}
  präsentiert sein Projekt. \scnn{Professor Brändi}, \scnn{Giovanni Benini} und
  eine weitere \scnn{Architektin} sitzen in der vordersten Reihe. Dahinter
  sammeln sich die Studenten. Jan beendet gerade seine Präsentation.}
...
\dlg{Prof. Brändi}{Sie zeigen hier eine Reihe sehr interessanter Ansäzte. Mich
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{ext}{Dachterrasse - Apéro}{Abend}{\scnn{Jan}, \scnn{Tim}, \scnn{Alessia}
  und \scnn{weitere Freunde} stehen auf der Dachterrasse und feiern das Ende der
  Kritik mit einem oder zwei Gin Tonic.}
...
\dsc{\scnn{Jens} geht zufällig gerade an der Gruppe vorbei.}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Jans Zimmer}{Abend}{\scnn{Jan} spricht mit \scnn{Mira}. Sie will nicht
  aufhören zu lernen, und löchert Jan mit Fragen zu Architektur, deren
  Geschichte und den Menschen in Zürich.}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{WG}{Abend}{\scnn{Alessia} und \scnn{Tim} sprechen über Jan}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{WG}{Abend}{Zwischenschnitt. - \scnn{Tim} und \scnn{Alessia} kommen
  sich näher. Aus den neckischen Sprüchen sind bald richtige Annäherugsversuche
  entstanden. Nach dem Wegfallen der Hemmungen durch ein, zwei weitere Gin Tonic
  Tanzen die beiden nun mit einigem Körperkontakt. Alessia flüstert Tim etwas
  ins Ohr.}


% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Hoschschulmensa}{Mittag des nächsten Tages}{\scnn{Alessia} und
  \scnn{Tim} stehen in der Warteschlange der Mensa. \scnn{Jan} tritt dazu. Er
  wirkt immer noch müde.}
...
\dsc{Die Situation zwischen \scnn{Alessia} und \scnn{Tim} scheint sichtlich
  verändert. \scnn{Jan} bemerkt dies sofort und hackt nach.}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Jans Zimmer}{Abend}{\scnn{Jan} ist wieder zuhause in seinem Zimmer und
  Startet seinen Computer. \scnn{Mira} meldet sich sofort. Jan schaltet sie aber
  sofort aus}
...
% ---------- scene ----------------------------------------------------------- %
% ############################################################################ %
\scn{int}{Yanevs Labor}{Abend}{Man sieht eine dunkle Silhouette vor seinem
  Bildschirm ohne zu erkennen wer es ist. Es handelt sich um
  \scnn{Dr. Yanev}. Auf dem Schirm sind eben jene Pläne von Jan und Mira zu
  erkennen, die Jan zuvor von seinem Tisch gewischt hat. Mit einem zufriedenen
  Lächeln und nicken massiert er weiter die Tasten.}
