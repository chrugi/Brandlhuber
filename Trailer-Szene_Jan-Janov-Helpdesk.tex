...
\dlg{Yanev}{Hier ist deine klapperkiste. Es sollte nun alles wieder
  funktionieren.}

\xdlg{Jan}{Vielen vielen Dank.}{kurz angebunden}
...
\dsc{Jan nimmt den Laptop entgegen und geht richtung Tür. Man erkennt eine
  teilweise Erleichterung, aber spührt immer noch seine Verzweiflung. Er scheint
  nicht mehr an einen Erfolg mit der Abgabe zu glauben.}
