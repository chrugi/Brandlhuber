\documentclass[a4paper,ngerman,11pt]{scrartcl}
  ...
  \texttt{
    ...
    \begin{center}
      ...
      \uppercase{\LARGE{\MakeUppercase{EP: I; Helpdesk}}}\\
      \vspace*{1cm}
      \uppercase{\normalsize{von}}\\
...
\scn{int}{D-ARCH Helpdesk, ETH Hönggerberg}{Abend}{\scnn{Jan Aebersold} tritt
  zur Tür herein. Er ist sehr angespannt. Mit grossen Schritten nähert er sich
  der Arbeitsnische von \scnn{Dr. Darko Yanev}. Dieser wartet schon mit einem
  undeutbaren Lachen vor seiner Theke und streckt Jan dessen Laptop entgegen.}

\dlg{Yanev}{Hier ist deine klapperkiste. Ich habe sie für dich wieder
  flott gemacht.}

\dlg{Jan}{Vielen Dank. Ich hoffe, dass ich jetzt wenigstens noch einen Teil
  meiner Abgabe erledigen kann.}

\dlg{Yanev}{Ich habe dir die neue Version der Software installiert. Die läuft um
  einiges schneller als die alte. Viel Glück noch.}

\dlg{Jan}{Danke. Noch einen schönen Abend.}

\dsc{Jan nimmt den Laptop entgegen und geht richtung Tür. Man erkennt eine
  teilweise Erleichterung, aber spührt immer noch seine Verzweiflung.}
