\documentclass[a4paper,ngerman,11pt]{scrartcl}
  ...
  \texttt{
    ...
    \begin{center}
      ...
      \uppercase{\LARGE{\MakeUppercase{EP: III; Vorlesung}}}\\
      \vspace*{1cm}
      \uppercase{\normalsize{von}}\\
...
\scn{int}{Hörsaal Hochschule}{Vormittag}{\scnn{Dr. Darko Yanev} steht am
  Rednerpult in einem Grossen Hörsaal an der Hochschule. Er ist inmitten einer
  Präsentation über seine Künstliche Intelligenz. Die \scnn{Zuhörerschaft
  (Statisten)} ist interessiert und sitzt gespannt da. Yanev hebt stolz die
  Vorzüge seiner eigenen Schöpfung gegenüber allem Vorangegangenen hervor. Seine
  künstliche Intelligenz ist nicht auf logische Entscheide limitiert, sondern
  vermag es auch kreative und künstlerische Aspekte zu berücksichtigen und
  eigenständige Ideen einzubringen.}

\xdlg{Yanov}{Neben dem selbstständigen erfassen aller relevanten Daten vermag es
  Mira auch diese nicht nur kritisch zu beurteilen, sondern auch intuitiv darauf
  zu Reagieren und daraus eine eigene IDEE zur Esthetik zu generieren.
  Sicherlich begreiffen Sie wie viele Arbeitsstunden wir so in unserem Alltag
  einsparen können. Die Zukunft heisst MIRA!}{begeistert}
