...
\scn{int}{ETH Hönggerberg - Studio Brändi}{Abend}{\scnn{Prof. Jakob Brändi}
  sitzt gemeinsam mit seinen \scnn{Studenten (Statisten, +Jan +Tim +Alessia)} in
  einem Kreis im Studio. Nach den gemeinsamen Besprechungen ihrer Projekte hat
  er nun eine Diskussion über das Paradigma der künstlichen Intelligenz in der
  Architektur angezettelt.}
